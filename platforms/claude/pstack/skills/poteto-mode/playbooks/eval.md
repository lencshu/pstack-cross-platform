...
5. **Spawn one blinded judge** on a different available Claude model tier per the **arena** skill's Phase C. Judge sees outputs by sanitized label and the rubric, never a model name.
