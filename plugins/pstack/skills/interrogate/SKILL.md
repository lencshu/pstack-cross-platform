...
Launch all reviewers in a single message using the Task tool. Use the `interrogate reviewers` list from `~/.pstack/codex-models.md` when present, one reviewer per entry, extending or shrinking the Reviewer A/B/C labels below to the configured entry count; otherwise use the table defaults.

| Subagent | Default model |
|----------|---------------|
| Reviewer A | `gpt-5.6-sol (max)` |
| Reviewer B | `gpt-5.6-sol-max` |
| Reviewer C | `gpt-5.6-terra (medium)` |
